...
public class pastWorkoutsController extends Controller{
	...
	@FXML private TableView<tempList> view;
	@FXML private TableColumn<tempList,String> date;
	@FXML private TableColumn<tempList,String> type;
	@FXML private TableColumn<tempList,String> intensity;
	@FXML private TableColumn<tempList,String> duration;
